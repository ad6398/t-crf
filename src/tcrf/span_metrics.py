...
class SpanBasedF1Measure:
    ...
    def __init__(
        ...
        self._label_vocabulary = id2label
    ...
    def get_metric(self, reset: bool = False):
        ...
        for tag in all_tags:
            ...
            precision_key = "span-precision" + "-" + tag
            recall_key = "span-recall" + "-" + tag
            f1_key = "span-f1-measure" + "-" + tag
        ...
        all_metrics["span-precision-overall"] = precision
        all_metrics["span-recall-overall"] = recall
        all_metrics["span-f1-measure-overall"] = f1_measure
        if reset:
            self.reset()
        return all_metrics
